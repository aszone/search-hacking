...
use Aszone\SearchHacking\Engines\DuckDuckGo;

class DuckDuckGoTest extends \PHPUnit_Framework_TestCase
{
    private $instance;

    public function setUp()
    {
        $this->instance = new DuckDuckGo(['dork' => 'site:com.ar ext:sql password']);
    }
